...
-- Zrzucanie danych dla tabeli kkurdziel.absence: ~7 rows (około)
DELETE FROM `absence`;
...
-- Zrzucanie danych dla tabeli kkurdziel.exam: ~16 rows (około)
DELETE FROM `exam`;
...
-- Zrzucanie danych dla tabeli kkurdziel.exam_result: ~31 rows (około)
...
INSERT INTO `exam_result` (`ex_res`, `ex_id`, `t_id`, `st_id`, `mark`, `comment`, `mark_time`) VALUES
	...
	(47, 24, 40, 87, '6-', 'Brawo', '2017-02-12');
...
-- Zrzucanie danych dla tabeli kkurdziel.parent: ~9 rows (około)
DELETE FROM `parent`;
...
-- Zrzucanie danych dla tabeli kkurdziel.parent_student: ~9 rows (około)
...
-- Zrzucanie danych dla tabeli kkurdziel.person: ~35 rows (około)
DELETE FROM `person`;
/*!40000 ALTER TABLE `person` DISABLE KEYS */;
INSERT INTO `person` (`pr_id`, `name`, `surname`, `pesel`, `mail`, `phone_nr`) VALUES
	(1, 'Jan', 'Kowalski', '90101012345', 't@asda', '131231222'),
	...
	(87, 'test1student', 'test1', '12314121412', 'asdads@asdasd', '123111111'),
	(95, 'test2parent', 'test2', '12421412412', 'asd@a', '123123123');
...
-- Zrzucanie danych dla tabeli kkurdziel.session: ~0 rows (około)
DELETE FROM `session`;
...
-- Zrzucanie danych dla tabeli kkurdziel.student: ~14 rows (około)
DELETE FROM `student`;
...
CREATE TABLE IF NOT EXISTS `student_class` (
  ...
  `is_active` varchar(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'T' COMMENT 'Trigger przy dodawaniu/usuwaniu',
...
-- Zrzucanie danych dla tabeli kkurdziel.student_class: ~12 rows (około)
DELETE FROM `student_class`;
/*!40000 ALTER TABLE `student_class` DISABLE KEYS */;
INSERT INTO `student_class` (`st_cl_id`, `st_id`, `cl_id`, `data_rozp`, `data_zak`, `is_active`) VALUES
	(1, 38, 20, '2016-02-04 16:11:41', NULL, 'T'),
	(3, 39, 20, '2016-02-04 16:12:09', NULL, 'T'),
	(4, 43, 20, '2016-02-04 16:11:41', NULL, 'T'),
	(5, 47, 20, '2016-02-04 16:11:41', NULL, 'T'),
	(6, 82, 21, '2016-02-04 16:11:41', NULL, 'T'),
	(7, 2, 20, '2016-02-04 16:11:41', NULL, 'T'),
	(8, 75, 20, '2016-02-04 16:11:41', NULL, 'T'),
	(9, 79, 21, '2016-02-04 16:11:41', NULL, 'T'),
	(10, 66, 21, '2016-02-04 16:11:41', NULL, 'T'),
	(11, 44, 21, '2016-02-04 16:11:41', NULL, 'T'),
	(18, 72, 20, '2017-02-12 21:06:05', NULL, 'T'),
	(20, 87, 20, '2017-02-12 21:47:41', NULL, 'T');
...
-- Zrzucanie danych dla tabeli kkurdziel.student_course: ~72 rows (około)
...
-- Zrzucanie danych dla tabeli kkurdziel.user: ~28 rows (około)
DELETE FROM `user`;
...
INSERT INTO `user` (`us_id`, `username`, `hashed_pwd`, `pr_id`) VALUES
	...
	(42, 'test1', '21232f297a57a5a743894a0e4a801fc3', 87),
	(43, 'test2', '21232f297a57a5a743894a0e4a801fc3', 95);
...
-- Zrzucanie danych dla tabeli kkurdziel.user_logs: ~177 rows (około)
...
INSERT INTO `user_logs` (`ul_id`, `time`, `ip`, `us_username`, `type`, `value`) VALUES
	...
	(166, '2017-02-06 23:14:58', '::1', 'admin', 'good_login', NULL),
	(167, '2017-02-12 20:33:57', '::1', 'admin', 'good_login', NULL),
	(168, '2017-02-12 21:19:48', '::1', 'micmac', 'good_login', NULL),
	(169, '2017-02-12 21:20:17', '::1', 'admin', 'good_login', NULL),
	(170, '2017-02-12 21:20:43', '::1', 'micmac', 'good_login', NULL),
	(171, '2017-02-12 21:22:16', '::1', 'próba1', 'good_login', NULL),
	(172, '2017-02-12 21:22:41', '::1', 'próba2', 'good_login', NULL),
	(173, '2017-02-12 21:29:42', '::1', 'admin', 'good_login', NULL),
	(174, '2017-02-12 21:48:26', '::1', 'test1', 'bad_login_u', NULL),
	(175, '2017-02-12 21:49:01', '::1', 'admin', 'good_login', NULL),
	(176, '2017-02-12 21:49:45', '::1', 'test1', 'good_login', NULL),
	(177, '2017-02-12 21:50:02', '::1', 'test2', 'good_login', NULL),
	(178, '2017-02-12 21:50:20', '::1', 'micmac', 'good_login', NULL),
	(179, '2017-02-12 21:51:04', '::1', 'test1', 'good_login', NULL),
	(180, '2017-02-12 21:51:22', '::1', 'test2', 'good_login', NULL),
	(181, '2017-02-12 21:56:22', '::1', 'test2', 'good_login', NULL),
	(182, '2017-02-12 21:56:37', '::1', 'test1', 'good_login', NULL),
	(183, '2017-02-12 22:09:12', '::1', 'admin', 'good_login', NULL),
	(184, '2017-02-12 22:09:23', '::1', 'admin', 'password_change', '21232f297a57a5a743894a0e4a801fc3'),
	(185, '2017-02-12 22:09:32', '::1', 'admin', 'bad_login_u', NULL),
	(186, '2017-02-12 22:09:37', '::1', 'admin', 'good_login', NULL),
	(187, '2017-02-12 22:09:45', '::1', 'admin', 'password_change', 'e00cf25ad42683b3df678c61f42c6bda'),
	(188, '2017-02-12 22:09:52', '::1', 'admin', 'good_login', NULL),
	(189, '2017-02-12 22:10:00', '::1', 'admin', 'good_login', NULL);
...
-- Zrzucanie danych dla tabeli kkurdziel.user_role: ~29 rows (około)
...
-- Zrzut struktury widok kkurdziel.v_student_class
-- Tworzenie tymczasowej tabeli aby przezwyciężyć błędy z zależnościami w WIDOKU
...
-- Zrzut struktury wyzwalacz kkurdziel.after_student_class
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `after_student_class` AFTER INSERT ON `student_class` FOR EACH ROW BEGIN
DECLARE done INT DEFAULT FALSE;
DECLARE cr_id INT;

DECLARE cur1 CURSOR FOR SELECT course_id from class_course where class_id = new.cl_id;
...
ins_loop: LOOP
	FETCH cur1 into cr_id;
	IF done THEN
		LEAVE ins_loop;
	END IF;
	INSERT INTO student_course (st_id, course_id) values (new.st_id, cr_id);
END LOOP;
CLOSE cur1;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`kkurdziel`@`%` VIEW `v_student_class` AS SELECT st.st_id, p.name, p.surname, p.pesel, st_cl.cl_id from student st
left join student_class st_cl on st.st_id = st_cl.st_id
...
inner join person p on p.pr_id = st.st_id
left join course c on c.cour_id = sc.course_id
